...
def main_menu():
    ...
    print(' 4 - Exit.\n')
    menu_option_int = int(input("Choose an option: "))
...
def option3():
    ...
    for pair in coins_upper:
        ...
        input_margin_float = (100 + float(input("Plese input stop-buy margin (in %): ") or 0)) / 100
        ...
        unidades = int(btc_available/trigger_price_float)
...
def clock_reset():
    global stop
    stop = (datetime.datetime.now() + datetime.timedelta(hours=12)) 
